...
/*
* to set db test vs. prod choose one of the two below
*/
//import com.ticketnetwork.tnwebservices_test.tnwebservice.v3.*;
import com.ticketnetwork.tnwebservices.tnwebservice.v3.*;
...
public class jdata3 {
        ...
        try {
            ...
            try{
                props.load(new FileInputStream(jdata_props_filename));
            }catch(Exception e){
            ...
            try{
                city_mappings.load(new FileInputStream("city_mappings.ini"));
                state_province_mappings.load(new FileInputStream("state_province_mappings.ini"));
                country_mappings.load(new FileInputStream("country_mappings.ini"));
            ...
            //update categories
             ...
             try{
                        ...
                        TNWebServiceStringInputs tns = new TNWebServiceStringInputs();
