...
{
      public class TNGridControl : Control
      {
...
strSQL += " LIMIT "+numberOfEvents_+" ";
   ...
   // myDataAdapter.Fill(myDataSet, "Events");
    ...
    //OdbcConnection conn= new OdbcConnection("DSN=jproj");
    //OdbcConnection conn= new OdbcConnection("Driver={MySQL ODBC 3.51 Driver};Server=76.12.107.205;Port=1378;Database=jproj;User=jdata;Password=jjoaky11;Option=3;");
